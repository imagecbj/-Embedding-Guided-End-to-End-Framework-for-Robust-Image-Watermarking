...
#######################################
    ...
    new_run_parser.add_argument('--epochs', '-e', default=1300, type=int, help='Number of epochs to run the simulation.')
    ...
    new_run_parser.add_argument('--message_length', '-m', default=1024, type=int, help='The length of the watermark.')
    ...
    if args.command == 'continue':
        ...
        hidden_config = HiDDenConfiguration(H=args.size, W=args.size,
                                            message_length=1024,
                                            encoder_blocks=4,encoder_channels=16,
                                            decoder_blocks=7, decoder_channels=16,
                                            use_discriminator=True,
                                            use_vgg=False,
                                            discriminator_blocks=3, discriminator_channels=16,
                                            decoder_loss=0.3,
                                            encoder_loss=0.7,
